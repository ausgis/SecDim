...
#'
#' @name obs
#' @format \code{obs}: A tibble of trace elements with 614 rows and 5 variables
#' @docType data
...
#'
#' @name grids
#' @format \code{grids}: A tibble of explanatory variables with 68757 rows and 11 columns.
#' @docType data
#' @author Yongze Song \email{yongze.song@curtin.edu.au}
